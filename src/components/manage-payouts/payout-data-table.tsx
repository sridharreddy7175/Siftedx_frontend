...
export const PayoutDataTable: React.FC<Props> = (props) => {
    return (
        <div>
            <table className="table table-borderless table-sm">
                <thead>
                    <tr className='table_row billing_data_heading' style={{ borderTop: "0.1px solid #BBBBBB" }}>
                ...
                <tbody className='t_body billing_data_body'>
                    {props.tableData.map((item: any, i: number) => (
                        <tr key={i} className="" style={{borderTop: "0.1px solid #BBBBBB"}}>
