...
export const InterviewUpcomingList = () => {
    ...
    return (
        <div className='siftedx-table job_description_padding mt-0 rounded-3 mx-3'>
            {loading &&
                    ...
                    <div className='px-lg-3 d-sm-flex justify-content-sm-between'>
                        ...
                        <div className='d-flex search_and_filter_right_side position-relative'>
                            <div className="input-group candidate_search_bar_border mt-1">
                                <input type="text" className="form-control form_control_border" placeholder="Search candidates by name" aria-label="Username" aria-describedby="basic-addon1" value={searchStr} onKeyPress={(e) => onSearchText(e)} onInput={(e) => onSearchTextEmpty(e)} />
                                <span className="input-group-text input_group_text" id="basic-addon1"><i className="fa fa-search pointer" aria-hidden="true" onClick={() =>
                                      getInterviews(1, searchStr, fromDate, toDate)}></i></span>
                            </div>
                            ...
                            {/* {showFilterOptions && <div ref={filterOptionsref} className='filter_options row'>
                                ...
                                <div className='text-center'>
                                    <button className='large_btn_apply px-4 rounded filter_btn_position_candidates' onClick={onFliterGo}>Filter</button>
                                </div>
                            </div>} */}
                        </div>
                    </div>
            ...
            {interviews.length > 0 ? <DataTable TableCols={UpcomingDataGridCols} tableData={interviews} editInfo={onEditrecords} deleteInfo={onDeleterecords}
                        ...
                        <div className="bg-white p-4">
                            ...
                            <div className="row">
                                ...
                                <div className="col-12 mt-3 p-2">
                                    ...
                                    <div>
                                        <div className="row">
                                            <div className="col-6 download_heading_title p-2">Experience</div>
                                            <div className="col-6 download_heading_title p-2">Skills</div>
                                        </div>
