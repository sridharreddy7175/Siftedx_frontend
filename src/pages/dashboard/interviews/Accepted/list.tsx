...
export const AcceptedList = () => {
    ...
    toDate: string) => {
        ...
        SmeService.getUpcomingInterviews(data).then(res => {
            setUpCommingInterviews([])
            if (res.error) {
    ...
    return (
        <div>
            <div className='siftedx-table job_description_padding mt-lg-0 ms-3 me-3 ms-lg-3 me-lg-3' style={{minHeight:"500px"}}>
                        ...
                        <div className='px-lg-3 d-sm-flex justify-content-sm-between'>
                            ...
                            <div className='d-flex search_and_filter_right_side position-relative'>
                                <div className="input-group candidate_search_bar_border mt-1">
                                    <input type="text" className="form-control form_control_border form-search" value={searchStr} placeholder="Search candidates by name" aria-label="Username" aria-describedby="basic-addon1" onKeyPress={(e) => onSearchText(e)} onInput={(e) => onSearchTextEmpty(e)} />
                                ...
                                {
                                    isFilterOpen &&
                                    <button className='large_btn_filter w-auto  ms-3 rounded mt-1 px-2'
                                    onClick={clearFilter}
                                    >Clear&nbsp;Filter</button>
                                }
                                {showFilterOptions && <>
                                    ...
                                    <div ref={filterOptionsref} className='row rounded-3 sx-bg-page p-3 position-absolute end-0 top-100 mt-1 z-index-1055'>
                                        <div className='mb-2 col-12 col-lg-6'>
                                            <div className='me-lg-2'>
                                                ...
                                                <input className="form-control job_dis_form_control mt-2" type="date"
                ...
                {upCommingInterviews.length > 0 ? <DataTable TableCols={UpcomingDataGridCols} tableData={upCommingInterviews} editInfo={onEditrecords} deleteInfo={onDeleterecords}
