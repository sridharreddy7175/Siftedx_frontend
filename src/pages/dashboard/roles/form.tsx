...
export const RoleForm = () => {
    ...
    return (
        ...
        <div>
            ...
            {!loading && <div>
                <div className="row border-top border-primary mx-5 pt-5">
                ...
                <div className='siftedx-table mx-5 my-3 p-5'>
                            ...
                            <div className="row custom-form">
                                ...
                                <div className="col-md-6 px-3">
                                    <div className="mb-4">
                                        ...
                                        {isFormSubmitted && !getRoleInputValid('description') && <p className="text-danger">Please enter name</p>}
                                    </div>
                                </div>
                                <div className="col-md-6 px-3">
                                    <div className="mb-4">
                    ...
                    <div className="form-footer text-center py-3 text-end mt-4">
                        ...
                        <Link className="btn btn-danger px-5 rounded-12 text-decoration-none ms-2" to={`/dashboard/roles`}>Cancel</Link>
                    </div>
                </div>
            </div>}
        </div >
