...
import { SchedulersDataGridCols } from './data-grid-cols';
...
export const SchedulersList = () => {
    ...
    const onEditinterview = (data: any) => {
        history.push(`/dashboard/sme/schedulers/details`);
    }
    ...
    return (
        <div>
            ...
            <div className="add_company_border mx-5 px-3 pt-3 pb-5" style={{ marginBottom: '15px' }}>
                ...
                {!loading && <DataTable TableCols={SchedulersDataGridCols} tableData={interviewList} editInfo={onEditinterview} deleteInfo={onDeleteinterview}
